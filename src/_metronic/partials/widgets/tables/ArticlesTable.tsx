...
// import { Add } from "../../../../app/modules/articles/Add";
// import { Edit } from "../../../../app/modules/articles/Edit";
...
const ArticlesTable: React.FC<Props> = ({ className }) => {
	...
	const fetchArticles = (page: number = 0) => {
		fetch(`http://167.172.165.109:8080/api/v1/articles?page=${page}`)
	...
	const handleDelete = (id: string) => {
		fetch(`http://167.172.165.109:8080/api/v1/articles/${id}`, {
			method: "DELETE",
		})
			.then((response) => {
				if (response.ok) {
		...
		<div className={`card ${className}`}>
			<div className="card-header border-0 pt-5">
				...
				<div className="card-toolbar">
					...
					{/* <Add onAddSuccess={() => fetchArticles(page)} /> */}
				</div>
			</div>
			<div className="card-body py-3">
				<div className="table-responsive">
					...
					{/* <Edit
						...
						onEditSuccess={() => fetchArticles(page)}
					/> */}
				</div>
